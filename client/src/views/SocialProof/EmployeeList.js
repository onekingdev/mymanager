...
// ** Table Columns
// import ExpandableTable, { useColumns } from '../contacts/employee/list/useColumns';
import ExpandableTable, { useColumns } from './AddColumns';
...
import { deleteEmployeeReset } from '../contacts/store/reducer';
...
const EmployeeList = () => {
  ...
  const empData = employeeList?.data?.list;
