...
import { sendEmail } from '../../../../requests/invoice/invoice'

const SidebarSendInvoice = ({ open, toggleSidebar,data }) => {
  ...
  const handleSendInvoice =()=>{
    let payload ={...mail,invoiceId:data?._id,recipient:data?.customerId?.email}
    mutate(payload)
...
We would appreciate payment of this invoice by 05/11/2019`}
        ...
        <div className='d-flex flex-wrap mt-2'>
          <Button className='me-1' color='primary' onClick={handleSendInvoice}>
            Send
          </Button>
