...
function ByAttendance({ dispatch, retentionListByAttendence }) {
  ...
  useEffect(()=>{
    if(retentionListByAttendence){
      setRetentionData(retentionListByAttendence)
    }
  ...
  //console.log(retentionListByAttendence)
  return (
    <Card style={{ marginLeft: '10px' }}>
      <CardBody className="rounded-none">
        <CardTitle tag="h4">
          <div className="d-flex justify-content-between">
            <div>Retention {'> '} By Attendance</div>
            <div>
              <div>
                <FormGroup>
                    ...
                    <Col md={4} className="my-auto">
                      ...
                      <Button
                        ...
                        onClick={() => {
                          Swal.fire({
                            title: 'Delete?',
                            text: 'Are you sure you want to delete the this attendance?',
                            // icon: 'warning',
