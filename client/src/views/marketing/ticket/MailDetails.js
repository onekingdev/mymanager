...
const MailDetails = (props) => {
  ...
  document.addEventListener('mousedown', closeEmployeeMenus);
        ...
        <CardHeader className="email-detail-head">
                  ...
                  <Table className="font-small-3" size="sm" borderless>
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          {formatDateToMonthShort(obj.createdAt)}, {formatTime(obj.createdAt)}
                        </td>
                      </tr>
                    </tbody>
                  </Table>
          ...
          <div className="mail-meta-item d-flex align-items-center">
            <small className="mail-date-time text-muted">
              {formatDateToMonthShort(obj.updatedAt, false)}, {formatTime(obj.updatedAt)}
            </small>
