...
const OrgInfoCard = ({ selectedOrg,toggleSendRecipients }) => {
    // ** State
                                    ...
                                    <div className='d-flex justify-content-center mt-50'>
                                        ...
                                        {selectedOrg?.path && (
                                            <>
                                                ...
                                                /{selectedOrg?.path}/register
                                            </>
                                        )}
                                    </span>
                                    <Copy className='ms-50' />
                                            </Badge>
                                            <Send size={18} onClick={toggleSendRecipients} style={{cursor:"pointer"}} className="text-primary my-auto ms-1" />
                                    </div>
                                </div>
                            </div>
                        </div>
