...
import EditLocationModal from '../../../../locations/edit/EditLocationModal'
...
export default function LocationTab({store,dispatch,selectedOrg}) {
    ...
    const toggleEditLocation = () => setOpenEditLocation(!openEditLocation)
  ...
  return (
   ...
   <NewLocationModal toggle={toggleLocation} open={openLocation} dispatch={dispatch} selectedOrg={selectedOrg}/>
            {selectedLocation && <EditLocationModal open={openEditLocation} toggle={toggleEditLocation} location={selectedLocation} org={selectedOrg} dispatch={dispatch}/>}
  </Fragment>
  )
}
