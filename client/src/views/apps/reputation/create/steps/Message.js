                ...
                if (res?.success) {
                    ...
                    const reci = rec.map((c) => {
                        ...
                        c = {
                            ...c,
                            hashCode: code,
                            url: `https://${organization!== null ? organization.path : 'me'}.mymanager.com/document/email-link/${code}`
                        }
                        return c
                    })
                    ...
                    if (recipients.length === 1 && recipients[0].name === '') {
                        mutate({
                            ...
                            mymanagerUrl: `https://${organization!== null ? organization.path : 'me'}.mymanager.com/document`,
                            recipients: [],
                            properties: [],
