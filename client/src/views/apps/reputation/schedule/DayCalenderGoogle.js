...
function DayCalendar(props) {
  ...
  useEffect(() => {
    var facebookResponse = JSON.parse(localStorage.getItem('facebookResponse'));

    if (facebookResponse !== '') {
      setFbLoginResponse(facebookResponse);
    }
  }, []);

  useEffect(() => {}, [fbLoginResponse]);
    ...
    <>
      <div className="w-100 shadow p-3 mb-5 bg-white rounded  ">
        <div className="p-2" style={{ textAlign: 'center' }}>
          <h1>Connect your Facebook or Google Business page</h1>
        </div>
            ...
            >
              ...
              >
                <div>
                  ...
                  {/* {fbLoginResponse?.picture !== undefined ? (
                    <img
                      alt="Sample"
                      style={{ height: 50, width: 50 }}
                      src={fbLoginResponse?.picture?.data?.url}
                    />
                  ) : null} */}
                  ...
                  <div className="d-flex justify-content-center ">
                    <CardSubtitle className="mb-1 text-muted text-center" tag="h6">
        ...
        <div className="d-flex justify-content-between  mt-3 p-4">
          ...
          <Button color="secondary" className="btn-next" outline disabled onClick={handleClick}>
