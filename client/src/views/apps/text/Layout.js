...
import { getTextContacts } from '../../marketing/text/store';
    ...
    <div className="d-flex w-100">
      <div className="width-30-per p-1">
        <Card className="shadow-sm sidebar-content">
          ...
          />
          <div
            className="chat-user-list-wrapper list-group py-2"
            options={{ wheelPropagation: false }}
          >
            {/* <h4 className="py-2">Unread Messages</h4> */}
            ...
            <h4 className="py-1 px-2">Messages</h4>
            <UserChatList
