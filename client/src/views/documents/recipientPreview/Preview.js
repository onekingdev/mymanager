...
import { getMembershipById } from '../../../requests/membership';
import MembershipAmount from './properties/membership/MembershipAmount';
import MembershipName from './properties/membership/MembershipName';
import MembershipType from './properties/membership/MembershipType';
import MembershipDuration from './properties/membership/MembershipDuration';
import MembershipDurationType from './properties/membership/MembershipDurationType';
import MembershipBalance from './properties/membership/MembershipBalance';
import MembershipDescription from './properties/membership/MembershipDescription';
import MembershipDownPayment from './properties/membership/MembershipDownPayment';
import MembershipFrequency from './properties/membership/MembershipFrequency';
import MembershipPaymentCount from './properties/membership/MembershipPaymentCount';
import MembershipTotalBoard from '../edit/drags/membersips/totalPrice/MembershipTotalPriceBoard';
import MembershipTotalPrice from './properties/membership/MembershipTotalPrice';
import MembershipStartDate from './properties/membership/MembershipStartDate';
import MembershipEndDate from './properties/membership/MembershipEndDate';
import MembershipRegFee from './properties/membership/MembershipRegFee';
import MembershipNextPayment from './properties/membership/MembershipNextPayment';
import MembershipDue from './properties/membership/MembershipDue';
import { getBoughtMembershipByIdAction } from '../../shops/store/action';
  ...
  useEffect(() => {
    ...
    if (now < Number(expTime) && token) {
      ...
      getDocumentWithToken(token, hashcode).then((data) => {
        ...
        console.log(doc)
        //------- check for membership & template
        if(doc?.isTemplate===false){
          //get & set membership data

          if(doc.docType){
            switch (doc.docType) {
              case 'contract':
                //membership
                dispatch(getBoughtMembershipByIdAction(doc.relateTo)).then(res=>{
                  console.log(res)
                  setMembership(res)
                })
                break;
                          ...
                          >
                            {board &&
                              board
                                ...
                                .map((item, idx) => {
                                  switch (item?.type) {
                                    ...
                                    case 'line':
                                      ...
                                      case 'membershipName':
                                  return (
                                    <MembershipName key={idx} item={item} membership={membership} />
                                  );
                                  case 'membershipType':
                                    return (
                                      <MembershipType key={idx} item={item} membership={membership} />
                                    );
                                    ...
                                    return (
                                      <MembershipAmount key={idx} item={item} membership={membership} />
                                    );
                                ...
                                return (
                                  <MembershipStartDate
                                  key={idx} item={item} membership={membership}
                                  />
                                );
