...
export const fetchAllDayTaskList = (payload) => {
  return API.get('/task/get-all-tasks', {
    params: payload
  });
};
...
export const freezeTask = (payload) => {
  return API.post('/task/new-freeze-task', payload);
};

export const acceptFreezeTask = (payload) => {
  return API.post('/task/accept-freeze-task', payload);
};
