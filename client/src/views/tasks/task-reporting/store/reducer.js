...
export const Tasks = createSlice({
  ...
  reducers: {
    ...
    // ** All Day Task List
    allDayTaskListStart: (state) => {
      state.allDayTaskList.loading = true;
    },
    allDayTaskListSuccess: (state, action) => {
      state.allDayTaskList.loading = false;
      state.allDayTaskList.success = true;
      state.allDayTaskList.error = null;
      state.allDayTaskList.list = action.payload;
    },
    allDayTaskListError: (state, action) => {
      state.allDayTaskList.loading = false;
      state.allDayTaskList.success = true;
      state.allDayTaskList.error = action.payload;
    },
    allDayTaskListReset: (state, action) => {
      state.allDayTaskList.loading = false;
      state.allDayTaskList.success = false;
      state.allDayTaskList.error = null;
    },
    ...
    // ** Send Freeze Request
    sendFTRQStart: (state) => {
      state.sendFTRQ.loading = true;
    },
    sendFTRQSuccess: (state, action) => {
      state.sendFTRQ.loading = false;
      state.sendFTRQ.success = true;
      state.sendFTRQ.error = null;
      state.sendFTRQ.result = action.payload;
    },
    sendFTRQError: (state, action) => {
      state.sendFTRQ.loading = false;
      state.sendFTRQ.success = true;
      state.sendFTRQ.error = action.payload;
    }
  }
});
