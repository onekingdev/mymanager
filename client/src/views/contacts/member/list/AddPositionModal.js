...
import { useCreateNewPosition, deleteMemberPositionRQ } from '../../../../requests/contacts/member-contacts'
...
const AddPositionModal = ({
    ...
    // pass member position data to db
    const { mutate } = useCreateNewPosition()


    // new member position data submit handler
    const handleSubmit = (event) => {
        event.preventDefault()

        const position = event.target.position.value
        const memberPosition = { position: position }
    ...
    // Delete member Position Modal state
