...
export const employeeSchedule = createSlice({
  ...
  reducers: {
    ...
    // ** Get Shift
    employeeShiftFetchStart: (state, action) => {
      state.shifts.isLoading = true;
      state.shifts.isSuccess = false;
    },
    employeeShiftFetchSuccess: (state, action) => {
      state.shifts.isLoading = false;
      state.shifts.isSuccess = true;
      state.shifts.shiftList = action.payload;
    },
    employeeShiftFetchError: (state, action) => {
      state.shifts.isLoading = false;
      state.shifts.isSuccess = false;
      state.shifts.error = action.payload;
    },
    // ** Get Budget
    employeeBudgetFetchStart: (state, action) => {
      state.budgets.isLoading = true;
      state.budgets.isSuccess = false;
    },
    employeeBudgetFetchSuccess: (state, action) => {
      state.budgets.isLoading = false;
      state.budgets.isSuccess = true;
      state.budgets.salesProjected = action.payload;
    },
    employeeBudgetFetchError: (state, action) => {
      state.budgets.isLoading = false;
      state.budgets.isSuccess = false;
...
export const {
  ...
  employeeShiftFetchError,

  // Budget
  employeeBudgetFetchStart,
  employeeBudgetFetchSuccess,
  employeeBudgetFetchError
} = employeeSchedule.actions;

export default employeeSchedule.reducer;
