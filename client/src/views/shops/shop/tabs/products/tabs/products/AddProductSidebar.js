...
import { createProductAction } from '../../../../../store/action';

export default function AddProductSidebar({ open, toggle, dispatch, store }) {
  ...
  const handleSubmitForm = () => {
    ...
    if (selectedFile === null) {
      toast.error('photo must not be empty!');
      return;
    }
    ...
    useUploadSignature(formData).then((res) => {
      ...
      dispatch(createProductAction(store.shop._id, payload));
    });
  };
    ...
    >
      <Row>
        <Col md="6">
          ...
          <Input onChange={handleInputChange} name="name" placeholder="Product Name" />
        </Col>
        <Col md="6">
         ...
         <Label className="form-label">
          ...
          <Button color='link' onClick={handleAddBrand} size='sm py-0'>Add +</Button>
         </div>
         <Input type="select" onChange={handleInputChange} name="brandId" placeholder="Brand">
      ...
      <Row>
        ...
        <Label className="form-label">
            ...
            <Input onChange={handleCheckPath} invalid={invalidPath} name="path" placeholder="Path that users get to" />
        </Col>
      </Row>
      <Row>
        <Col md="6">
        ...
        <Col md="6">
          ...
          <Button color='link' onClick={toggleCategoryModal} size='sm py-0'>Add +</Button>
          </div>
          <Input type="select" onChange={handleInputChange} name="categoryId" placeholder="Brand">
            <option value="select">select...</option>
      ...
      <Row>
        ...
        <Col md="6">
          ...
          <Input type="select" name="isSignatured" onChange={handleInputChange}>
      ...
      {/* <Row>
        <Col md="6">
          <Input type='checkbox' name='freeShipping' onChange={handleInputChange}/>
          <Label className="form-label" >
            Free Shipping
          </Label>
