...
import { Card, NavLink, TabContent, TabPane } from 'reactstrap';
              ...
              <PerfectScrollbar className="sidebar-menu-list" options={{ wheelPropagation: false }}>
                <ListGroup tag="div" className="list-group-messages">
                  <ListGroupItem
                    ...
                    action
                  >
                    <FaUsers size={18} className="me-75" />
                    <span className="align-middle">Contact Statistics</span>
                  </ListGroupItem>
                  <ListGroupItem
                    tag={NavLink}
                    onClick={() => toggleTab('2')}
                  ...
                  <ListGroupItem
                    ...
                    active={active === '3'}
                  >
                    <MdOutlineLeaderboard size={18} className="me-75" />
                  ...
                  <ListGroupItem
                    ...
                    active={active === '4'}
                  >
                    <GiRank1 size={18} className="me-75" />
