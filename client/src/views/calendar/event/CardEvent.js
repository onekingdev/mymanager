...
const CardEvent = (props) => {
  ...
  const getEventStartTime = () => {
    const startTime = eventInfo.start ? new Date(eventInfo.start) : new Date();
    return startTime;
  };
  ...
  return (
    <Card className="card-developer-meetup">
      <div className="meetup-img-wrapper rounded-top text-center">
        ...
        <img src={eventInfo.url ? eventInfo.url : 'https://mymanager.com/assets/images/photo.png'} height="170" alt="Event Banner" className="w-100" />
      </div>
      <CardBody>
