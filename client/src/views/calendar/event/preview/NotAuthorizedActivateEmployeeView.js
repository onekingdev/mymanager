          ...
          if (res.userData.permission[item] == true) {
            ...
            if (item == 'mysocial') {
              newAbility.push(
                {
                  action: 'manage',
                  subject: 'mysocial/socialconnect'
                },
                {
                  action: 'manage',
                  subject: 'mysocial/socialproof'
                },
                {
                  action: 'manage',
                  subject: 'mysocial/reputation/'
                }
              );
            }
            newAbility.push({
    ...
    <Fragment>
      ...
      <div className="mt-5">
        <div className="d-flex justify-content-center align-items-center">
          ...
          <Button color="primary ms-1" onClick={activateClickHandler}>
            Click Here
          </Button>
        </div>
        <span className="mt-5 d-flex justify-content-center font-large-1">
          To activate to mymanager.com, just click button
        </span>
      </div>
    </Fragment>
  );
