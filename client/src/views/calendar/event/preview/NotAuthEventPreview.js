...
const NotAuthEventPreview = () => {
  // ** Store variable
  const dispatch = useDispatch();
  const { eventInvitation } = useParams();

  const { eventId, contactId, contactEmail } = JSON.parse(atob(eventInvitation));
                ...
                <div className="d-flex align-items-center">
                  <div className="mb-0 me-auto font-medium-2 font-weight-bold">
                    <h4 className="fw-bolder text-uppercase">
                      <span className="font-large-1 text-primary">{eventInfo.type}</span> event
                      manager{' '}
                    </h4>
                  </div>
                </div>
            ...
            <div className="event-details-wrapper mt-5">
              ...
              <div className="event-details-aside">
                <div className="conversion-bar conversion-bar--checkout-opener eds-fx--slide-up d-flex flex-column justify-content-center text-center">
                  {['product', 'membership', 'ticket'].includes(eventInfo.checkoutType) && (
                    <>
...
export default NotAuthEventPreview;
