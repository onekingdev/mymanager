...
const Address = ({ stepper, type, eventForm, eventInfo }) => {
  ...
  useEffect(() => {
    ...
    setValue('venueName', eventInfo.venueName ? eventInfo.venueName : '');
    setValue('eventAddress', eventInfo.eventAddress ? eventInfo.eventAddress : '');
    setValue('zip', eventInfo.zip ? eventInfo.zip : '');
  }, [eventInfo]);
