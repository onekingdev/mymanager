...
const Host = ({ stepper, type, eventForm, eventInfo }) => {
  ...
  useEffect(() => {
    setValue('hostName', eventInfo.hostName ? eventInfo.hostName : '');
    setValue('hostEmail', eventInfo.hostEmail ? eventInfo.hostEmail : '');
    setValue('hostMobileNumber', eventInfo.hostMobileNumber ? eventInfo.hostMobileNumber : '');
    setValue(
      'hostAlternateNumber',
      eventInfo.hostAlternateNumber ? eventInfo.hostAlternateNumber : ''
    );
  }, [eventInfo]);
          ...
          <Col md="6" className="mb-1">
            ...
            <Controller
              ...
              render={({ field: { value, onChange } }) => (
                <Input autoFocus placeholder="Enter Host Name" value={value} onChange={onChange} />
              )}
            />
            {errors.hostName && (
