...
export const basicData = [
  {
    title: 'Register and email confirmation',
    content: 'Register your account and confirm email',
    meta: '12 min ago',
    customContent: (
      <Button size="sm" color="primary" id="reportToggler" outline disabled>
        Done
      </Button>
    )
  },
  {
    ...
    content: 'Go to contact section and create any type of contact there.',
    meta: '45 min ago',
    color: 'secondary',
    customContent: (
  ...
  },
  {
    ...
    content: 'Go to taks and goals section and create one workspace and task',
    meta: '2 hours ago',
    color: 'success',
    customContent: (
      <Fragment>
  ...
  {
    title: 'Marketing',
    content: 'Create one automation flow in marketing section.',
    meta: '03:00 PM',
    color: 'warning',
    customContent: (
      <Fragment>
  ...
  },
  {
    ...
    content: 'Go to MySocial section and connect your workspace.',
    meta: '03:00PM',
    color: 'danger',
    customContent: (
      <Button
  ...
  {
    title: 'Shop',
    content: 'Create one product in shop page.',
    meta: (
