...
const MyCMARoutes = [
  ...
  {
    path: '/manage-usercourses/myai',
    extract: true,
    component: lazy(() => import('../../views/mycma/usercourses/manage/addMyAi'))
  },
  {
  ...
  // {
  //   path:'/mycma/mycourse/:courseid',
  //   component: lazy(() => import('../../views/mycma/usercourses/mycourse')),
  // },
