...
exports.create_stripe =asyncHandler( async (req, res) => {
  try {
...
exports.candidate_stripe_update =asyncHandler( async (req, res) => {
  try {
...
exports.candidate_stripe_detail = asyncHandler(async (req, res) => {
  try {
    const { stripeId } = req.params;
...
exports.candidate_stripe_remove =asyncHandler( async (req, res) => {
  const { stripeId } = req.params;
  const { userId } = req.params;
