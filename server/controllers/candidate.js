...
exports.candidate_create =asyncHandler( async (req, res) => {
  try {
...
exports.candidate_read =asyncHandler( async (req, res) => {
...
exports.candidate_update = asyncHandler(async (req, res) => {
...
exports.candidate_remove = asyncHandler(async (req, res) => {
  let candidateId = req.params.candidateId;
  let userId = req.user._id;
  let data = await Candidate.updateOne(
    { _id: mongoose.Types.ObjectId(candidateId), userId: userId },
