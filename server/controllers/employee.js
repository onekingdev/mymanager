...
const { Employee, EmployeeContact } = require("../models/index/index");

exports.newEmployee =asyncHandler(async (req, res) => {
  const {
    fullName,
    email,
    phone,
...
exports.getEmployeeByRoleId = asyncHandler(async (req, res) => {
  try {
    const { roleId } = req.params;
    const getEmployee = await EmployeeContact.find(
      {
        role: roleId,
      },
      {
