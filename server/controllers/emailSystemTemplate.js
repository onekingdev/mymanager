...
exports.admin_add_template = asyncHandler(async (req, res) => {
  try {
...
exports.add_template = asyncHandler(async (req, res) => {
  try {
...
exports.update_template = asyncHandler(async (req, res) => {
...
exports.remove_template =asyncHandler(async(req, res) => {
...
exports.status_update_template = asyncHandler(async(req, res) => {
...
exports.single_temp_update_status = asyncHandler(async(req, res) => {
...
exports.swapAndUpdate_template =asyncHandler(async (req, res) => {
...
exports.multipal_temp_remove =asyncHandler(async (req, res) => {
  let folderId = req.params.folderId;
