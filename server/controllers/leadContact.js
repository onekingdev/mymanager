...
const contactAdd = asyncHandler(async (req, res) => {
  const { fullName, email, phone, type, company, position, country, stage, tags } = req.body;
...
const addNewOther = asyncHandler(async (req, res) => {
  try {
...
const importContactsFromArray = asyncHandler(async (req, res) => {
  try {
...
const getLeadPositions =asyncHandler(async (req, res) => {
  try {
    const { user } = req;
...
const deleteLeadPosition = asyncHandler(async (req, res) => {
  try {
    const { id } = req.params;
...
const putLeadPosition = asyncHandler(async (req, res) => {
  try {
    const { id } = req.params;
    const { position } = req.body;
    const filter = { _id: id };
...
const getContactsByTags =asyncHandler(async (req, res) => {
  try {
    ...
    const data = await LeadContact.find({ tags: { $in: tag } });
