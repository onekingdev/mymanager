 const { EmailNurturingCategory } = require("../models/index/index");
...
exports.userEmailList =asyncHandler(async (req, res) => {
...
exports.admin_category_list = asyncHandler(async(req, res) => {
    EmailNurturingCategory.find({ adminId: req.params.adminId })
        .populate({
            path: 'folder',
            populate: {
                path: 'template',
...
exports.addcategory =asyncHandler(async (req, res) => {
    ...
    var category = new EmailNurturingCategory(cat);
...
exports.updateCategory =asyncHandler(async (req, res) => {
    EmailNurturingCategory.findByIdAndUpdate(req.params.categoryId, req.body)
        .exec((err, updateCat) => {
            if (err) {
...
exports.removeCategory =asyncHandler(async (req, res) => {
    EmailNurturingCategory.findByIdAndRemove(req.params.categoryId)
        .exec((err, delData) => {
            if (err) {
...
exports.tempList =asyncHandler( (req, res) => {
