...
data.affiliates.forEach((affiliate) => {
  affiliate.totalEarnings = Math.floor(Math.random() * 10000);
  affiliate.totalWithdrawals = Math.floor(
    Math.random() * affiliate.totalEarnings
  );
  affiliate.wallet = affiliate.totalEarnings - affiliate.totalWithdrawals;
  affiliate.pendingPayments = Math.floor(Math.random() * 1000);
});
